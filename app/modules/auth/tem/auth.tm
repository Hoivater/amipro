...
<body>
	<header>
		<a href="%name_site%">
			<img src="%name_site%/resourse/visible/fon_start2.svg" class="main_logo">
		</a>
	</header>
		<div class="main container-fluid mt-3">
			<div class="row">
					<div class="table_auth">
						<h3 class="text-center mt-1">Авторизация</h3>
						<form name = "auth" action = "%name_site%/app/form/FormRoute.php" method = "post">
							...
							<div class="message m-3">Восстановление пароля только через бот телеграма %message%</div>
						</form>
					</div>
			</div>
	</div>
