<?php
	...
	class Jon
	{
		...
		public function deleteMemoSe()
		{
			$nt = new Site\MemoTable();

			//создаем заметку
			$res = $nt -> deleteMemoS($this -> post_nohtml["link"]);
			echo $res;
		}
		...
		public function hideNoteLite()
		{
			$nt = new Site\NoteTable();

			//создаем заметку
			$res = $nt -> hideLite($this -> post_nohtml["link"]);
			echo $res;
		}
